namespace DotAllCombo.Heroes
{
    ...
    internal class EmberSpiritController : HeroController
    {
        ...
        private static bool Active, wKey;
        ...
        public override void OnInject()
        {
            ...
            DebugExtensions.Chat.PrintSuccess("I need your blood!");
        ...
        public override void OnUpdateEvent(EventArgs args)
        {
            ...
            var track =
                e.Modifiers.Any(
                    y => y.Name == "modifier_bounty_hunter_track_effect" || y.Name == "modifier_bounty_hunter_track");

            var invul = (e.Modifiers.Any(x => x.Name == "modifier_item_blade_mail_reflect") ||
                         e.Modifiers.Any(x => x.Name == "modifier_item_lotus_orb_active")
                         || e.Modifiers.Any(x => x.Name == "modifier_nyx_assassin_spiked_carapace") ||
                         e.Modifiers.Any(x => x.Name == "modifier_templar_assassin_refraction_absorb")
                         || e.Modifiers.Any(x => x.Name == "modifier_ursa_enrage") ||
                         e.Modifiers.Any(x => x.Name == "modifier_abaddon_borrowed_time") ||
                         (e.Modifiers.Any(x => x.Name == "modifier_dazzle_shallow_grave")));
			...
			*/
			...
			if (wKey && me.Distance2D(e) <= 1400 && e != null && e.IsAlive && !ModifInv)
			{
				if ( // MOM
					mom != null
					&& mom.CanBeCasted()
